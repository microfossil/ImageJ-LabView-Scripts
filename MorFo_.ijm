...
for (k = 0; k<list.length; k++) { 
        ...
        t2 = replace(t, ".tif", "");
        rename(t2);
        run("Analyze Particles...", "size=40-Infinity circularity=0.30-1.00 display exclude clear include summarize"); //This command is used to perform the specified measurements on each specimen of the image
        String.copyResults; 
